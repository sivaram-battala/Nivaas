...
const endpoints = {
  ...
  // OREDERS_LIST: 'orders',
  // FEED_COMMENTS_LIST: 'jtreel/comment/listbyfeed?feedId',
};

export const otpTrigger = async (otpPayload) => {
  try {
    let result = await axiosNivaas.post(endpoints.NIVAAS_OTP_TRIGGER, otpPayload);
...
export const StoreOTP = async data => {
  try {
    let result = await axiosbroadleaf.post(`${endpoints.STORE_OTP}`, data);
    return result;
  } catch (error) {
    return error;
  }
...
export const StoreCategoryList = async (pgNo, pgSz) => {
  try {
    let result = await axiosStore.get(
      `${endpoints.CATERGORT_LIST}?page=${pgNo}&pageSize=${pgSz}`,
    );
    return result;
  } catch (error) {
    return error;
...
export const StorePopularProducts = async (pgNo, pgSz) => {
  try {
    let result = await axiosStore.get(
      `${endpoints.STORE_POPULAR_PRODUCTS}?pageNo=${pgNo}&pageSize=${pgSz}&popular=true`,
    );
    return result;
  } catch (error) {
    return error;
...
export const StoreProductsDetails = async id => {
  try {
    let result = await axiosStore.get(
      `${endpoints.SRORE_PRODUCT_DETAILS}/${id}`,
    );
    return result;
  } catch (error) {
    console.log('StoreProductsDetails', error);
    return error;
  }
};
export const StoreCategoryProductsDetails = async (id, pgNo, pgSz) => {
  try {
    let result = await axiosStore.get(
      `${endpoints.CATERGORT_LIST_PRODUCTS}=${id}&pageNo=${pgNo}&pageSize=${pgSz}`,
    );
    return result;
  } catch (error) {
    console.log('StoreCategoryProductsDetails', error);
    return error;
  }
};
export const StoreCreateCart = async () => {
  try {
    let result = await axiosStore.get(`${endpoints.CREATE_CART}`);
    return result;
  } catch (error) {
    console.log('StoreCreateCart', error);
    return error;
  }
};
export const StoreAddToBag = async (cartId, data) => {
  console.log(cartId, data);
  try {
    let result = await axiosStore.post(
      `${endpoints.CREATE_CART}/${cartId}/item`,
      data,
    );
    return result;
  } catch (error) {
    console.log('StoreAddToBag', error);
    return error;
  }
};

export const StoreGetBag = async cartId => {
  try {
    let result = await axiosStore.get(`${endpoints.CREATE_CART}/${cartId}`);
    return result;
  } catch (error) {
    console.log('StoreGetBag', error);
    return error;
  }
};
export const StorePlaceOrder = async cartId => {
  try {
    let result = await axiosStore.post(`${endpoints.CHECKOUT_CART}/${cartId}`);
    return result;
  } catch (error) {
    console.log('StorePlaceOrder', error);
    return error;
  }
};
export const StoreCartPaymentId = async (cartId, data) => {
  try {
    let result = await axiosStore.post(
      `${endpoints.CART_PAYMENT_ID}?cartId=${cartId}`,
      data,
    );
    return result;
  } catch (error) {
...
export const StoreOrdersList = async () => {
  try {
    let result = await axiosStore.get(`${endpoints.OREDERS_LIST}`);
    return result;
  } catch (error) {
    console.log('StoreOrdersList', error);
    return error;
  }
};
export const StoreCartPayment = async (paymentId, cartId, data) => {
  try {
    let result = await axiosStore.put(
      `${endpoints.CART_PAYMENT_ID}/${paymentId}/transaction?cartId=${cartId}`,
      data,
    );
    return result;
  } catch (error) {
...
export const StoreDeleteCartItem = async (cartId, itemId) => {
  try {
    let result = await axiosStore.delete(
      `${endpoints.CREATE_CART}/${cartId}/items/${itemId}`,
    );
    return result;
  } catch (error) {
    console.log('StoreDeleteCartItem', error);
    return error;
  }
};
export const AddressUpdate = async data => {
  try {
    ...
    console.log('AddressUpdate', error);
    return error;
  }
};
...
export const EventScreenList = async (pgno, pgSize) => {
  try {
    let result = await axiosEventsData1.get(
      `${endpoints.EVENTS_SCREE_LIST}?pageNo=${pgno}&pageSize=${pgSize}`,
    );
    return result;
  } catch (error) {
    console.log('error', error);
...
export const ListFeedComments = async (feedId, pgNo, pgSz) => {
  console.log('----', feedId, pgNo, pgSz);
  try {
    let result = await axiosNewDataSave.get(
      `${endpoints.FEED_COMMENTS_LIST}=${feedId}&pageSize=${pgNo}&pageNo=${pgSz}`,
    );
    return result;
  } catch (error) {
    return error;
...
export const getTempleClassDetails = async (pgNo, pgSize, templeClass) => {
  try {
    let result = await axiosNotifications.get(
      `${endpoints.GET_TEMPLE_CLASS}/byTempleClass?seasonal=false&templeClass=${templeClass}&pageNo=${pgNo}&pageSize=${pgSize}`,
    );
    return result;
  } catch (error) {
    return error;
...
export const likeReelsAndUnlikeReels = async data => {
  try {
    let result = await axiosMultiPartFormData1.post(
      `${endpoints.REELS_LIKE_UNLIKE}`,
      data,
    );
    return result;
  } catch (error) {
...
export const getReelLikesCount = async reelId =>{
  try {
    let result = await axiosMultiPartFormData1.get(
      `${endpoints.REEL_LIKES_COUNT}?reelId=${reelId}`
    );
    return result;
  } catch (error) {
    console.log('erroget', error);
  }
};
